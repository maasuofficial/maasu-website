    ...
    return (
      <div className={`${modules.pageContainer} ${this.state.expanded ? modules.expanded : ''}`}>
        <Page className={`${modules.groupPage}`}>
          ...
          <p>
            Executive Coordinating Committee Applications for the 2020-2021 academic year are now open! Apply <a href="https://docs.google.com/forms/d/e/1FAIpQLScEnc2J5D-Yjqw7L-EWiDESrOTrppV1eEHjHH49Nf1JrCfx8w/viewform">here</a>. Applications close <b>Friday, March 13th</b>.
          </p>
        </Page>
        <Page className={`${modules.groupPage}`}>
